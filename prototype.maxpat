...
,
		"classnamespace" : "box",
		"rect" : [ 598.0, -1172.0, 1675.0, 884.0 ],
		"bglocked" : 0,
...
,
					"text" : "Random",
					"textcolor" : [ 0.749019607843137, 0.913725490196078, 1.0, 1.0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-17" : [ "number[18]", "number[18]", 0 ],
			"obj-18" : [ "number[6]", "number[5]", 0 ],
			"obj-2" : [ "number[19]", "number[19]", 0 ],
			"obj-25" : [ "number[20]", "number[20]", 0 ],
			"obj-28" : [ "number[22]", "number[22]", 0 ],
			"obj-30" : [ "number[21]", "number[21]", 0 ],
			"obj-36" : [ "number[17]", "number[17]", 0 ],
			"obj-41" : [ "live.gain~[1]", "live.gain~[1]", 0 ],
			"obj-55" : [ "number[24]", "number[24]", 0 ],
			"obj-58" : [ "number[23]", "number[23]", 0 ],
			"obj-67" : [ "number[2]", "number[5]", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
